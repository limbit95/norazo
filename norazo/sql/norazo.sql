...
SELECT * FROM ATTEND_MEMBER WHERE MEMBER_NO = 44;
DELETE FROM ATTEND_MEMBER WHERE MEMBER_NO = 44;

SELECT * FROM BOARD WHERE MEMBER_NO = 44;
COMMIT;
...
CREATE SEQUENCE SEQ_SECESSION_MEMBER_NO NOCACHE;
SELECT * FROM SECESSION_MEMBER;
DELETE FROM SECESSION_MEMBER;
COMMIT;

INSERT INTO SECESSION_MEMBER VALUES(
SEQ_SECESSION_MEMBER_NO.NEXTVAL,    
'test3@naver.com',    
'$2a$10$z/MTfHEwEcrStspy.BV0ke8a71PI91TEKP5HWkaa8vaLB0YzDRI5W',    
'test',    
'01012341234',    
NULL,    
'M',    
...
DROP SEQUENCE SEQ_SECESSION_MEMBER_NO;